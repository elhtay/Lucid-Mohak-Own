...
# This script is part of the LUCID project. The LUCID project is a research project that aims to develop a lightweight deep learning solution for DDoS attack detection.
# Modifications has been made to this script for research purposes
# The original script is available at: https://github.com/doriguzzi/lucid-ddos?tab=readme-ov-file#lucid-a-practical-lightweight-deep-learning-solution-for-ddos-attack-detection

# Modifications has been made to process the UDP traffic (in CICDDos2019 dataset).
import sys
import time
import pyshark
import socket
